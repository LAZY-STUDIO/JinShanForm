...
进入`form-server`文件夹(我们提供了默认的账号:`lazy` 密码:`123456`, 可以直接登录查看数据效果)
...
- 新建表单填写页面整体的 UI 结构，分为头部组件，中间表单信息，左侧题目列表进度条
  ...
  ![postman](./mdImgs/QQ图片20220616153506.png)
...
- 通过获取表单的接口类型，编写获取表单的方法
  ...
  ![postman](./mdImgs/image-20220616155308600.png)
...
- 新建个人中心的 UI 结构，包含头部，操作区域，个人信息展示区域，以及设置个人信息，设置密码两个模块
  ...
  ![postman](./mdImgs/QQ图片20220616154335.png)
...
- 根据表单题目列表信息进行类型判断以及 value 判断，渲染出题目列表右侧小图标是否点亮的效果
  ...
  ![postman](./mdImgs/QQ图片20220616154544.png)
...
- 实现题目列表中点击导航到页面中每题位置的效果
  ...
  ![postman](./mdImgs/QQ图片20220616154842.png)
...
- 添加表单填写页面的弹窗效果，使用二维码或者链接分享表单
  ...
  ![postman](./mdImgs/image-20220616155011115.png)
